...
O ficheiro "Babel.js" tem de incluir, logo nas primeiras linhas, um comentÃ¡rio
inicial contendo: o nome e nÃºmero dos dois alunos que realizaram o projeto;
indicaÃ§Ã£o de quais as partes do trabalho que foram feitas e das que nÃ£o foram
feitas (para facilitar uma correÃ§Ã£o sem enganos); ainda possivelmente alertando
para alguns aspetos da implementaÃ§Ã£o que possam ser menos Ã³bvios para o avaliador.
...
// first line
    ...
    eventHandler(i, "onclick", "play('japanese/sentences/ä½•æ™‚ã§ã™ã‹.mp3');");
    text(p1, 16, " ");
    text(p1, 32, "ä½•æ™‚ã§ã™ã‹");
